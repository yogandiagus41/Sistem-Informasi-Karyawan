    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h5><b>Data Peminjaman Ruangan</b></h5>
                <form action="/action_page.php">
                    <div class="mb-3 mt-3">

                        <input type="text" class="form-control" id="email" placeholder="Nama Peminjam" name="TU">
                    </div>
                    <div class="mb-3">

                        <input type="text" class="form-control" id="pwd" placeholder="Tanggal Peminjaman" name="pswd">
                    </div>
...
<body style="background-color: #b4cfb0;">
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <ul class="dropdown-menu bg-dark ">
            ...
            <li><a class="dropdown-item" href="ruangan.php">Ruangan</a></li>
        </ul>
                    ...
                    <div class="shadow-lg p-4 mb-4 bg-white">
                        ...
                        <div class="card">
                            <button type="button" class="btn btn-primary m-4" data-bs-toggle="modal"
                                ...
                                Data Peminjaman Ruangan baru</button>
                            <div class="card-body">
