        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5><b>Data Keuangan</b></h5>
                    <form action="/action_page.php">
                        <div class="mb-3 mt-3">

                            <input type="text" class="form-control" id="email" placeholder="Uang Masuk" name="TU">
                        </div>
                        <div class="mb-3">

                            <input type="text" class="form-control" id="pwd" placeholder="Uang Keluar" name="pswd">
                        </div>
