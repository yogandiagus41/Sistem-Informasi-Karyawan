        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5><b>Data Mata Pelajaran</b></h5>
                    <form action="prosesCreateMapel.php" method="POST">
                        <div class="mb-3 mt-3">

                            <input type="text" class="form-control" id="mapel" placeholder="Nama Mata Pelajaran"
                                name="mataPelajaran">
                        </div>
                        <div class="mb-3">

                            <input type="text" class="form-control" id="jml" placeholder="Jumlah guru Pengajar"
                                name="jumlahGuru">
                        </div>
        ...
        <div class="container-fluid mt-4">
            ...
            <div class="shadow-lg p-4 mb-4 bg-white">
                ...
                <div class="alert alert-success">
                    <strong>Success!</strong><?php echo "Pendaftaran mata pelajaran baru berhasil!";  ?>
                </div>
                <?php
                        } else {?>
                <div class="alert alert-warning">
                    <strong>Failed!</strong><?php echo "Pendaftaran mata pelajaran baru gagal!";  ?>
                </div>
                <?php
                        }
                        ?>
                ...
                <div class="card">
                    <button type="button" class="btn btn-primary m-4" data-bs-toggle="modal"
                        ...
                        Data Mata Pelajaran Baru</button>
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="editMapel.php?id=<?php echo $user_data['id'];?>" type="button"
                                            class="btn btn-primary">Edit</a>
                                        | <a href="HapusMapel.php?id=<?php echo $user_data['id'];?>"><button
