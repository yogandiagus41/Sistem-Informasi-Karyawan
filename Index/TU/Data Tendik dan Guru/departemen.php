        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5><b>Data Departemen</b></h5>

                    <form action="prosesCreateDepartemen.php" method="POST">
                        <div class="mb-3 mt-3">

                            <input type="text" class="form-control" id="dep" placeholder="Nama Departemen"
                                name="namaDepartemen">
                        </div>
                        <div class="mb-3">

                            <input type="text" class="form-control" id="jml" placeholder="Jumlah Tenaga Pendidik"
                                name="jumlahTendik">
                        </div>
                        <div class="mb-3">

                            <input type="text" class="form-control" id="rg" placeholder="Ruangan" name="ruangan">
                        </div>
        ...
        <div class="container-fluid mt-4">
            ...
            <div class="shadow-lg p-4 mb-4 bg-white">
                ...
                <div class="alert alert-success">
                    <strong>Success!</strong><?php echo "Pendaftaran departemen baru berhasil!";  ?>
                </div>
                <?php
                        } else {?>
                <div class="alert alert-danger">
                    <strong>Failed!</strong><?php echo "Pendaftaran departemen baru gagal!";  ?>
                </div>
                <?php
                        }
                        ?>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo($user_data['ruangan']); ?></td>
                                    <td><a href="editDepartemen.php?id=<?php echo $user_data['id'];?>" type="button"
                                            class="btn btn-primary">Edit</a>
                                        | <a href="HapusDepartemen.php?id=<?php echo $user_data['id'];?>"><button
